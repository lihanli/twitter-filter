...
(function() {
  var Tweet, filterCurrentPage, filterTweets, filteredPhrases, filteredUsers, hasClass, options, pageWatcher, setupPage;
  ...
  filterTweets = function(els) {
    ...
    removeConversationModule = function($el) {
      return $el.parents('ol.conversation-module').addClass('tf-hidden');
    };
